...
# NOTE: This is the `jest` management command as it existed in fiduwsrwiter v3, e.g.:
# https://github.com/fiduswriter/fiduswriter/blob/16b5d85/fiduswriter/base/management/commands/jest.py
